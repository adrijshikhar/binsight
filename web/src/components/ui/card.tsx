...
export function Card({
  ...
  const defaultProps = {
    className: cn(
      'relative flex flex-col rounded-lg border bg-card text-card-foreground [box-shadow:var(--panel-highlight)]',
      className,
    ),
    'data-slot': 'card',
  }
