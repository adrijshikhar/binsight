        ...
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Root
              key={toast.id}
              className={cn(
                "absolute z-[calc(9999-var(--toast-index))] h-(--toast-calc-height) w-full select-none rounded-lg border bg-[color-mix(in_srgb,var(--popover),var(--color-black)_calc(1%*max(0,var(--toast-index,0))))] text-popover-foreground [box-shadow:var(--panel-highlight)] [transition:transform_.5s_cubic-bezier(.22,1,.36,1),opacity_.5s,height_.15s,background-color_.5s] data-expanded:bg-popover dark:bg-[color-mix(in_srgb,var(--popover),var(--color-black)_calc(6%*max(0,var(--toast-index,0))))] dark:data-expanded:bg-popover",
        ...
        {toasts.map((toast) => {
          ...
          return (
            ...
            >
              <Toast.Root
                className={cn(
                  "relative text-balance border bg-popover text-popover-foreground text-xs [box-shadow:var(--panel-highlight)] transition-[scale,opacity] data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0",
                  tooltipStyle
                    ? "rounded-md"
                    : "rounded-lg",
                  upsertReplayClassName(toast),
